...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/GodKnowsJhomz/OCSAutoScript/master"
else
	source="https://raw.githubusercontent.com/GodKnowsJhomz/OCSAutoScript/master"
fi
...
read -p "Password: " -e -i OCS_PANEL DatabasePass
echo ""
...
echo 'echo -e "       | | |                         "' >> .bashrc
echo 'echo -e "       | | |__   ___  _ __ ___  ____ "' >> .bashrc
echo 'echo -e "   _   | | '_ \ / _ \| '_ ` _ \|_  / "' >> .bashrc
echo 'echo -e "  | |__| | | | | (_) | | | | | |/ /  "' >> .bashrc
echo 'echo -e "   \____/|_| |_|\___/|_| |_| |_/___| "' >> .bashrc
echo 'echo -e "Welcome to the server $HOSTNAME" | lolcat' >> .bashrc
echo 'echo -e "Script mod by shigeno"' >> .bashrc
echo 'echo -e "Script updated by GodKnowsJhomz"' >> .bashrc
...
cd /home/vps/public_html
wget https://raw.githubusercontent.com/GodKnowsJhomz/OCSAutoScript/master/OCSPanel.zip
unzip OCSPanel.zip
rm -f OCSPanel.zip
chown -R www-data:www-data /home/vps/public_html
...
echo "- Password: anything you want"
echo "- Confirm Password: as desired"
echo ""
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer OCS Panels Mod by shigeno, Updated by GodKnows Jhomz"  | tee -a log-install.txt
echo "                        "  | tee -a log-install.txt
echo "" | tee -a log-install.txt
